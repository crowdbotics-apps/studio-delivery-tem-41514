...
## Project Structure
    ...
    ├── studio_delivery_tem_41514  # Django project configurations
...
1. Clone this repo and `cd studio_delivery_tem_41514`
...
2. Clone this repo and `cd studio_delivery_tem_41514`
