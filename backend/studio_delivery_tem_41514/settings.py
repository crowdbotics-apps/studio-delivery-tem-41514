"""
Django settings for studio_delivery_tem_41514 project.
...
ROOT_URLCONF = 'studio_delivery_tem_41514.urls'
...
WSGI_APPLICATION = 'studio_delivery_tem_41514.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "studio_delivery_tem_41514 API",
    "DESCRIPTION": "API documentation for studio_delivery_tem_41514 App",
    "VERSION": "v1",
}
